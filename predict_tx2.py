...
class PowerLogger:
    ...
    def showDataTraces(self, names=None, valType='power'):
        ...
        for i, y in enumerate(Ps):
            l = plt.plot(Ts, y)
            llist.append(l)
        plt.legend(handles=llist, labels=names)
        # plt.xlabel('time [s]')
